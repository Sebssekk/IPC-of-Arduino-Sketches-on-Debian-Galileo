...
- [__nodoRD_led.ino__](Sketch/nodoRD_led.cpp "led Sketch code") it's a sketch who control a [red led](https://www.exploringarduino.com/parts/red-led/). It calls the Message Handler to receive data from `_sensor` shared memory. If this value is < 20cm it swith the led on.
